  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-20">
      ...
      <div className="flex flex-col gap-6">
        <Link href="/admin/tournaments" className="flex items-center gap-2 text-xs font-bold tracking-wide text-gray-400 hover:text-[#b50a0a] transition-colors w-fit">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 bg-red-50 text-[#b50a0a] text-xs font-bold tracking-wide rounded-full border border-red-100">
                {tournament.type} Tournament
              </span>
              <span className={`px-3 py-1 text-xs font-bold tracking-wide rounded-full border ${tournament.is_active ? 'bg-green-50 text-green-600 border-green-100' : 'bg-gray-50 text-gray-400 border-gray-100'}`}>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-gray-900 text-white px-4 md:px-8 py-4 rounded-2xl font-bold tracking-wide text-xs hover:bg-[#b50a0a] transition-all shadow-xl">
              Save Changes
            </button>
          </div>
        </div>
