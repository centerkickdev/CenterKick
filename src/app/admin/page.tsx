    ...
    return (
      <div className="space-y-8 animate-in fade-in duration-700">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
             <h1 className="text-3xl font-bold text-gray-900 tracking-tighter leading-none">CMS <span className="text-[#b50a0a]">Workspace</span></h1>
             <p className="text-xs font-bold text-gray-400 tracking-[0.2em] mt-2 flex items-center gap-2">
                <Globe className="w-3 h-3 text-[#b50a0a]" /> Blogger Control Active
             </p>
          </div>
          <div className="flex items-center gap-3">
             <div className="text-right hidden sm:block">
                <p className="text-xs font-bold text-gray-900 tracking-wide">Snapshot Date</p>
                <p className="text-xs font-bold text-gray-400">{new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</p>
             </div>
             <Link href="/admin/blog/new" className="bg-[#b50a0a] hover:bg-black text-white px-6 py-3 rounded-xl font-bold text-xs tracking-wide transition-all flex items-center gap-2 shadow-md">
            ...
            <Link key={i} href={stat.path} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-lg hover:shadow-gray-200/40 transition-all duration-500">
              ...
              <div className="space-y-1">
                 ...
                 <div className="flex items-end justify-between">
                    <p className="text-2xl font-bold text-gray-900 tracking-tighter leading-none">{stat.value}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-3 gap-4 md:p-8">
           ...
           <div className="lg:col-span-2 bg-gray-900 rounded-[2rem] p-4 md:p-8 text-white relative overflow-hidden shadow-2xl shadow-gray-400/20">
              ...
              <div className="relative z-10">
                 <div className="flex items-center justify-between mb-8">
                    <div>
                       <h2 className="text-xs font-bold text-[#b50a0a] tracking-[0.3em]">CMS Performance Glance</h2>
                       <p className="text-xl font-bold mt-1">Estimated Readership</p>
                    </div>
                 ...
                 <div className="flex items-end gap-10">
                    <div>
                       <p className="text-xs font-bold text-gray-500 tracking-wide mb-2">Simulated Views to Date</p>
                       <p className="text-4xl font-bold tracking-tighter leading-none">4,820<span className="text-base text-[#b50a0a]"> reads</span></p>
                    </div>
                    <div className="pb-1">
                       <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg">
                          <ArrowUpRight className="w-3 h-3 text-green-500" />
                          <span className="text-xs font-bold tracking-wide">Growth 15%</span>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="mt-4 flex items-center justify-between text-xs font-bold text-gray-600 tracking-wide px-1">
                    <span>Week 1</span>
                    <span>Week 2</span>
                    <span>Week 3</span>
                    <span>Week 4</span>
           ...
           <div className="bg-white rounded-[2rem] p-4 md:p-8 border border-gray-100 shadow-sm flex flex-col justify-between">
              <div>
                 <h2 className="text-xs font-bold text-gray-400 tracking-[0.2em] mb-6 font-bold">CMS Operations</h2>
                 <div className="space-y-4">
                    {[
                      ...
                      <Link key={i} href={tool.href} className="flex items-center gap-4 p-4 bg-gray-50 hover:bg-[#b50a0a]/5 hover:border-[#b50a0a]/20 border border-transparent rounded-2xl transition-all group">
                         ...
                         <div>
                            <p className="text-xs font-bold tracking-tight text-gray-900">{tool.label}</p>
                            <p className="text-xs font-bold text-gray-400 mt-0.5">{tool.desc}</p>
                         </div>
                      </Link>
                    ))}
                 </div>
        ...
        <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden p-4 md:p-8 space-y-6">
           <div>
              <h2 className="text-xs font-bold text-gray-900 tracking-wide leading-none">Your Recent Publications</h2>
              <p className="text-xs font-bold text-gray-400 tracking-wide mt-2">Quick access to recently created articles and drafts.</p>
           </div>
 ...
 post.published_at ? 'bg-green-50 text-green-600' : 'bg-amber-50 text-amber-600'
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
           <h1 className="text-3xl font-bold text-gray-900 tracking-tighter leading-none">System <span className="text-[#b50a0a]">Overview</span></h1>
           <p className="text-xs font-bold text-gray-400 tracking-[0.2em] mt-2 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-3 gap-4 md:p-8">
         ...
         <div className="lg:col-span-2 bg-gray-900 rounded-[2rem] p-4 md:p-8 text-white relative overflow-hidden shadow-2xl shadow-gray-400/20">
            ...
            <div className="relative z-10">
               <div className="flex items-center justify-between mb-8">
                  <div>
                     <h2 className="text-xs font-bold text-[#b50a0a] tracking-[0.3em]">Financial Statistics</h2>
                     <p className="text-xl font-bold mt-1">Total Revenue</p>
                  </div>
                  <TrendingUp className="w-6 h-6 text-white/20" />
               </div>
               ...
               <div className="flex items-end gap-10">
                  <div>
                     <p className="text-xs font-bold text-gray-500 tracking-wide mb-2">Earnings to date</p>
                     <p className="text-4xl font-bold tracking-tighter leading-none">$14,280<span className="text-base text-[#b50a0a]">.00</span></p>
                  </div>
                  <div className="pb-1">
                     <div className="flex items-center gap-2 bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg">
                        <ArrowUpRight className="w-3 h-3 text-green-500" />
                        <span className="text-xs font-bold tracking-wide">Growth 24%</span>
                     </div>
                  </div>
               </div>
         ...
         <div className="bg-white rounded-[2rem] p-4 md:p-8 border border-gray-100 shadow-sm flex flex-col justify-between">
            <div>
               <h2 className="text-xs font-bold text-gray-400 tracking-[0.2em] mb-6">User Subscriptions</h2>
                  ...
                  {[
                    ...
                    <div key={i} className="p-4 bg-gray-50 rounded-2xl space-y-3">
                       <div className="flex items-center justify-between">
                          <span className="text-xs font-bold tracking-tight text-gray-900">{sub.type}</span>
                          <span className="text-xs font-bold text-[#b50a0a] tracking-wide">{sub.subscribed + sub.unsubscribed} Total</span>
                       </div>
                       <div className="flex gap-4">
                          <div className="flex-1">
                             <p className="text-xs font-bold text-gray-400">Subscribed</p>
                             <p className="text-base font-bold text-gray-900">{sub.subscribed}</p>
                          </div>
                          <div className="flex-1 border-l border-gray-200 pl-4">
                             <p className="text-xs font-bold text-gray-400">Unsubscribed</p>
                             <p className="text-base font-bold text-gray-400">{sub.unsubscribed}</p>
                          </div>
                       </div>
                    </div>
                  ))}
            ...
            <Link href="/admin/payments" className="mt-8 group flex items-center justify-between p-5 bg-gray-50 rounded-2xl hover:bg-[#b50a0a] transition-all">
               <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold tracking-wide text-gray-900 group-hover:text-white transition-colors">Manage Subscriptions</span>
               </div>
