  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tighter leading-none">Scout <span className="text-[#b50a0a]">Directory</span></h1>
        ...
        <div className="flex items-center gap-3">
          <Link href="/admin/scouts?add=true" className="bg-[#b50a0a] hover:bg-black text-white px-6 py-4 rounded-2xl font-black text-[10px] tracking-wide transition-all flex items-center gap-2 shadow-xl shadow-red-900/10 active:scale-95">
