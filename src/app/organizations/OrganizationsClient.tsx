   ...
   return (
      <div className="max-w-[1200px] mx-auto px-4 lg:px-0 py-10 sm:py-16">
         <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10 pb-8 border-b border-gray-100">
            <div>
               <h2 className="text-2xl sm:text-3xl font-black text-gray-900 uppercase tracking-tighter">Registered Organizations</h2>
         ...
         {filtered.length === 0 ? (
            <div className="text-center py-20 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
               <p className="text-gray-500 font-bold uppercase tracking-widest text-sm">No matching organizations found.</p>
            </div>
         ) : (
                  ...
                  return (
                     <Link href={`/organizations/${org.slug}`} key={org.id}
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                           <span className="text-amber-400 text-[9px] font-bold uppercase tracking-widest block mb-0.5">{org.country || 'Global'}</span>
