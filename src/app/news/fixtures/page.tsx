         ...
         <main className="pt-32">
            ...
            <div className="bg-[#383838] py-8">
               <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
                  <h1 className="text-white text-3xl font-bold tracking-wide">Fixtures</h1>
               </div>
            </div>
            ...
            <div className="bg-[#292929] border-b border-gray-800">
               <div className="max-w-[1200px] mx-auto px-4 lg:px-0">
                  <ul className="flex items-center gap-8 overflow-x-auto [&::-webkit-scrollbar]:hidden scroll-smooth whitespace-nowrap">
                     ...
                     <li>
                        <Link href="/news/fixtures" className="text-[#b50a0a] text-xs font-bold tracking-wide py-4 block">
                           Match Fixtures
                        </Link>
                     </li>
                     <li>
            ...
            <div className="max-w-[1000px] mx-auto px-4 sm:px-6 py-8">
               ...
               <div className="flex flex-wrap items-center gap-4 border-y border-gray-300 py-3 mb-8">
                  ...
                  <div className="hidden md:flex border-l border-gray-300 pl-6 h-full items-center">
                     <button className="flex items-center gap-2 text-xs font-bold text-gray-600 tracking-wide hover:text-gray-900 transition-colors">
                              ...
                              <div className="p-6">
                                 ...
                                 <div className="flex justify-center mb-6">
                                    <div className="text-center">
                                       ...
                                       <span className="text-xs font-bold text-gray-900 tracking-wide">{match.date} | {match.time}</span>
                                    </div>
                                 </div>
                                 ...
                                 <div className="flex items-center justify-center gap-4 mt-8">
                                    {Object.entries(match.odds).map(([key, value]) => (
                                       <div key={key} className="flex items-center border border-gray-200 rounded text-xs font-bold w-20 overflow-hidden shadow-sm">
                                    ...
                                    <div className="flex items-center ml-2">
                                       <span className="text-xs font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded border border-green-100">bet9ja</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
