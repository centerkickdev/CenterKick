      ...
      <main className="pt-32 sm:pt-40 pb-24 overflow-hidden">
        ...
        <section className="max-w-[1200px] mx-auto px-4 lg:px-0 mb-20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-xs font-bold tracking-[0.3em] text-[#b50a0a]">Global Updates</span>
          </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 h-full">
                    ...
                    <div className="lg:col-span-5 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-white text-left">
                      <div className="flex flex-col">
                        <DateDisplay date={mainNews.published_at} className="text-gray-400 text-xs font-bold tracking-wide mb-3 block" />
                        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 leading-tight mb-4 tracking-tighter group-hover:text-[#b50a0a] transition-colors">
                          {mainNews.title}
                        </h2>
                      ...
                      <div className="mt-6 flex items-center gap-2 text-sm font-bold text-[#b50a0a] tracking-wide group-hover:translate-x-2 transition-transform duration-300">
                  ...
                  >
                    ...
                    <div className="relative w-full sm:w-40 lg:w-44 aspect-[16/10] sm:aspect-square rounded-2xl overflow-hidden bg-black shrink-0">
                      ...
                      <div className="absolute top-3 left-3 z-20">
                        <span className="bg-[#b50a0a] text-white text-xs font-bold tracking-wide px-2.5 py-1 rounded-full shadow-md">
                          Hot Story
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col justify-center py-2 text-left">
                      ...
                      <h3 className="text-base sm:text-base font-bold text-gray-900 leading-snug tracking-tight line-clamp-3 group-hover:text-[#b50a0a] transition-colors">
                        {news.title}
                      </h3>
                      {news.excerpt && (
          ...
          {carouselNews.length > 0 && (
            <div className="mt-12 bg-white/50 backdrop-blur-sm border border-gray-100 p-8 rounded-[2.5rem] shadow-sm">
              <h4 className="text-sm font-bold tracking-wide text-gray-400 mb-6 text-left">More Recent Stories</h4>
              <ProfileCarousel 
                items={carouselNews}
                renderItem={(news) => (
                  <Link 
                  ...
                  >
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between text-left">
                      <DateDisplay date={news.published_at} className="text-gray-400 text-xs font-bold tracking-wide mb-1.5 block" />
                      <h5 className="text-sm font-bold text-gray-900 leading-snug line-clamp-3 group-hover:text-[#b50a0a] transition-colors">
                        {news.title}
                      </h5>
                    </div>
                  </Link>
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div>
              ...
              <h2 className="text-3xl font-bold text-gray-900 tracking-tighter">
                Players <span className="text-[#b50a0a] font-bold">Profiles</span>
              </h2>
            </div>
            <Link 
              href="/players" 
        ...
        <section className="max-w-[1200px] mx-auto px-4 lg:px-0 mb-28">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-xs font-bold tracking-[0.25em] text-[#b50a0a]">Representation Network</span>
              </div>
              <h2 className="text-3xl font-bold text-gray-900 tracking-tighter">
              ...
              <div className="group bg-white border border-gray-100 rounded-[2rem] p-6 shadow-md hover:shadow-xl transition-all duration-500 h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="text-center mb-4">
                    <span className={`inline-block text-xs font-bold tracking-wide px-2.5 py-1 rounded-full mb-2 ${
 ...
 : 'bg-[#b50a0a]/5 text-[#b50a0a] border border-[#b50a0a]/10'
        ...
        <section className="max-w-[1200px] mx-auto px-4 lg:px-0 mb-28">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-xs font-bold tracking-[0.25em] text-[#b50a0a]">Development Centers</span>
              </div>
              <h2 className="text-3xl font-bold text-gray-900 tracking-tighter">
                Organizations <span className="text-[#b50a0a] font-bold">Profiles</span>
              </h2>
            </div>
            <Link 
              href="/register" 
            ...
            renderItem={(org) => (
              <div className="group bg-white border border-gray-100 rounded-3xl p-6 shadow-md hover:shadow-xl hover:border-amber-500/10 transition-all duration-500 h-full flex flex-col justify-between">
                <div>
                  ...
                  <div className="text-center mb-4">
                    <span className="inline-block bg-amber-50 text-amber-600 border border-amber-100 text-xs font-bold tracking-wide px-2.5 py-0.5 rounded-full mb-2">
                      Academy Partner
                    </span>
        ...
        <section className="max-w-[1200px] mx-auto px-4 lg:px-0 mb-28">
          <div className="flex items-center gap-3 mb-2">
            <span className="w-8 h-[2px] bg-[#b50a0a]"></span>
            <span className="text-xs font-bold tracking-[0.3em] text-[#b50a0a]">Skill Showreel</span>
          </div>
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
            <h2 className="text-3xl font-bold text-gray-900 tracking-tighter">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            {highlights.length === 0 && (
              <div className="col-span-full py-16 text-center bg-white border border-dashed border-gray-200 rounded-[2rem] p-8">
                ...
                <h4 className="text-sm font-bold text-gray-400 tracking-wide">No highlight clips currently active.</h4>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="max-w-[1200px] mx-auto px-4 lg:px-0">
          <div className="bg-gradient-to-br from-[#b50a0a] via-[#900000] to-black rounded-[3rem] p-10 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="flex flex-col items-center relative z-10">
              ...
              <span className="text-white/80 text-xs md:text-sm font-bold tracking-[0.4em] mb-4">
